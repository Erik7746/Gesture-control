...
@dataclass(frozen=True)
class ModelConfig:
    """Rutas y umbrales de confianza de los modelos MediaPipe."""
...
@dataclass(frozen=True)
class ROIConfig:
    """Parámetros de Regiones de Interés."""

    size_factor: float = 2.2
